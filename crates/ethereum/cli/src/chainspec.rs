use reth_chainspec::{ChainSpec, DEV, HOLESKY, MAINNET, SEPOLIA, THREESIXNINE};
use reth_cli::chainspec::{parse_genesis, ChainSpecParser};
use std::sync::Arc;

/// Chains supported by reth. First value should be used as the default.
pub const SUPPORTED_CHAINS: &[&str] = &["mainnet", "sepolia", "holesky", "threesixnine", "dev"];
...
pub fn chain_value_parser(s: &str) -> eyre::Result<Arc<ChainSpec>, eyre::Error> {
    Ok(match s {
        ...
        "threesixnine" => THREESIXNINE.clone(),
        "dev" => DEV.clone(),
